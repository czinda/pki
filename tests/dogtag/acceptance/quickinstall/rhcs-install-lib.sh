...
rhcs_install_RootCA() {
	...
	rlLog "Creating CA Instance"
		...
		exp_message3_2="systemctl status pki-quarkusd@$ROOTCA_TOMCAT_INSTANCE_NAME.service"
		...
		exp_message4_2=" systemctl restart pki-quarkusd@$ROOTCA_TOMCAT_INSTANCE_NAME.service"
...
rhcs_install_kra() {
	...
	#Install and configure RHDS instance
		...
		exp_message1="Administrator's username:             $(eval echo \$KRA${number}_ADMIN_USER)"
                ...
                exp_message5="systemctl status pki-quarkusd@$(eval echo \$KRA${number}_TOMCAT_INSTANCE_NAME).service"
                rlAssertGrep "$exp_message5" "$INSTANCE_CREATE_OUT"
                exp_message6="To restart the subsystem:"
                rlAssertGrep "$exp_message6" "$INSTANCE_CREATE_OUT"
                exp_message7=" systemctl restart pki-quarkusd@$(eval echo \$KRA${number}_TOMCAT_INSTANCE_NAME).service"
...
rhcs_install_ocsp() {
	...
	#Install and configure RHDS instance
		...
		exp_message1="Administrator's username:             $(eval echo \$OCSP${number}_ADMIN_USER)"
                ...
                exp_message3_1="To check the status of the subsystem:"
                rlAssertGrep "$exp_message3_1" "$INSTANCE_CREATE_OUT"
                exp_message3_2="systemctl status pki-quarkusd@$(eval echo \$OCSP${number}_TOMCAT_INSTANCE_NAME).service"
                rlAssertGrep "$exp_message3_2" "$INSTANCE_CREATE_OUT"
                exp_message4_1="To restart the subsystem:"
                rlAssertGrep "$exp_message4_1" "$INSTANCE_CREATE_OUT"
                exp_message4_2=" systemctl restart pki-quarkusd@$(eval echo \$OCSP${number}_TOMCAT_INSTANCE_NAME).service"
                rlAssertGrep "$exp_message4_2" "$INSTANCE_CREATE_OUT"
                exp_message5="The URL for the subsystem is:"
                rlAssertGrep "$exp_message5" "$INSTANCE_CREATE_OUT"
...
rhcs_install_tks() {
	...
	local SUBSYSTEM_NAME=$(echo TKS${number})
		...
		rlLog "EXECUTING: pkispawn -s TKS -f $INSTANCECFG -v "
                ...
                exp_message3_1="To check the status of the subsystem:"
                rlAssertGrep "$exp_message3_1" "$INSTANCE_CREATE_OUT"
                exp_message3_2="systemctl status pki-quarkusd@$(eval echo \$TKS${number}_TOMCAT_INSTANCE_NAME).service"
                rlAssertGrep "$exp_message3_2" "$INSTANCE_CREATE_OUT"
                exp_message4_1="To restart the subsystem:"
                rlAssertGrep "$exp_message4_1" "$INSTANCE_CREATE_OUT"
                exp_message4_2=" systemctl restart pki-quarkusd@$(eval echo \$TKS${number}_TOMCAT_INSTANCE_NAME).service"
                rlAssertGrep "$exp_message4_2" "$INSTANCE_CREATE_OUT"
                exp_message5="The URL for the subsystem is:"
                rlAssertGrep "$exp_message5" "$INSTANCE_CREATE_OUT"
...
rhcs_install_tps() {
	...
	local INSTANCE_NAME=$(eval echo \$TPS${number}_TOMCAT_INSTANCE_NAME)
		...
		rlAssertGrep "$exp_message1" "$INSTANCE_CREATE_OUT"
                exp_message3_1="To check the status of the subsystem:"
                rlAssertGrep "$exp_message3_1" "$INSTANCE_CREATE_OUT"
                exp_message3_2="systemctl status pki-quarkusd@$(eval echo \$TPS${number}_TOMCAT_INSTANCE_NAME).service"
                rlAssertGrep "$exp_message3_2" "$INSTANCE_CREATE_OUT"
                exp_message4_1="To restart the subsystem:"
                rlAssertGrep "$exp_message4_1" "$INSTANCE_CREATE_OUT"
                exp_message4_2=" systemctl restart pki-quarkusd@$(eval echo \$TPS${number}_TOMCAT_INSTANCE_NAME).service"
                rlAssertGrep "$exp_message4_2" "$INSTANCE_CREATE_OUT"
                exp_message5="The URL for the subsystem is:"
                rlAssertGrep "$exp_message5" "$INSTANCE_CREATE_OUT"
...
rhcs_install_cloneCA()
{
	...
	rlRun "mkdir /tmp/dummydir"
		...
		HOSTNAME_CLONE=`hostname`
                ...
                exp_message3_1="To check the status of the subsystem:"
                rlAssertGrep "$exp_message3_1" "$INSTANCE_CREATE_OUT"
                exp_message3_2="systemctl status pki-quarkusd@$(eval echo \$CLONE_CA${number}_TOMCAT_INSTANCE_NAME).service"
                rlAssertGrep "$exp_message3_2" "$INSTANCE_CREATE_OUT"
                exp_message4_1="To restart the subsystem:"
                rlAssertGrep "$exp_message4_1" "$INSTANCE_CREATE_OUT"
                exp_message4_2=" systemctl restart pki-quarkusd@$(eval echo \$CLONE_CA${number}_TOMCAT_INSTANCE_NAME).service"
                rlAssertGrep "$exp_message4_2" "$INSTANCE_CREATE_OUT"
                exp_message5="The URL for the subsystem is:"
                rlAssertGrep "$exp_message5" "$INSTANCE_CREATE_OUT"
...
rhcs_install_SubCA(){
	...
	#Install eval echo $(eval echo $SUBCA${number} INSTANCE
		...
		echo "pki_backup_keys=$(eval echo \$SUBCA${number}_BACKUP)" >> $INSTANCECFG
                ...
                exp_message3_1="To check the status of the subsystem:"
                rlAssertGrep "$exp_message3_1" "$INSTANCE_CREATE_OUT"
                exp_message3_2="systemctl status pki-quarkusd@$(eval echo \$SUBCA${number}_TOMCAT_INSTANCE_NAME).service"
                rlAssertGrep "$exp_message3_2" "$INSTANCE_CREATE_OUT"
                exp_message4_1="To restart the subsystem:"
                rlAssertGrep "$exp_message4_1" "$INSTANCE_CREATE_OUT"
                exp_message4_2=" systemctl restart pki-quarkusd@$(eval echo \$SUBCA${number}_TOMCAT_INSTANCE_NAME).service"
                rlAssertGrep "$exp_message4_2" "$INSTANCE_CREATE_OUT"
                exp_message5="The URL for the subsystem is:"
                rlAssertGrep "$exp_message5" "$INSTANCE_CREATE_OUT"
	...
	local SUBSYSTEM_NAME=$(echo CloneKRA${number})
		...
		echo "pki_ds_database=$(eval echo \$${MASTER_KRA}_LDAP_INSTANCE_NAME)" >> $INSTANCECFG
 		cat $INSTANCECFG
                ...
                exp_message4="To check the status of the subsystem:"
                rlAssertGrep "$exp_message4" "$INSTANCE_CREATE_OUT"
                exp_message5="systemctl status pki-quarkusd@$(eval echo \$CLONE_KRA${number}_TOMCAT_INSTANCE_NAME).service"
                rlAssertGrep "$exp_message5" "$INSTANCE_CREATE_OUT"
                exp_message6="To restart the subsystem:"
                rlAssertGrep "$exp_message6" "$INSTANCE_CREATE_OUT"
                exp_message7=" systemctl restart pki-quarkusd@$(eval echo \$CLONE_KRA${number}_TOMCAT_INSTANCE_NAME).service"
                rlAssertGrep "$exp_message7" "$INSTANCE_CREATE_OUT"
                exp_message8="The URL for the subsystem is:"
                rlAssertGrep "$exp_message8" "$INSTANCE_CREATE_OUT"
...
rhcs_install_cloneOCSP(){
	...
	rlLog "$SUBSYSTEM_NAME"
		...
		echo "pki_ds_database=$(eval echo \$${MASTER_OCSP}_LDAP_INSTANCE_NAME)" >> $INSTANCECFG
                ...
                exp_message3_1="To check the status of the subsystem:"
                rlAssertGrep "$exp_message3_1" "$INSTANCE_CREATE_OUT"
                exp_message3_2="systemctl status pki-quarkusd@$(eval echo \$CLONE_OCSP${number}_TOMCAT_INSTANCE_NAME).service"
                rlAssertGrep "$exp_message3_2" "$INSTANCE_CREATE_OUT"
                exp_message4_1="To restart the subsystem:"
                rlAssertGrep "$exp_message4_1" "$INSTANCE_CREATE_OUT"
                exp_message4_2=" systemctl restart pki-quarkusd@$(eval echo \$CLONE_OCSP${number}_TOMCAT_INSTANCE_NAME).service"
                rlAssertGrep "$exp_message4_2" "$INSTANCE_CREATE_OUT"
                exp_message5="The URL for the subsystem is:"
                rlAssertGrep "$exp_message5" "$INSTANCE_CREATE_OUT"
...
rhcs_install_cloneTKS(){
	...
	local DOMAIN=$(eval echo $master_hostname | cut -d. -f2-)
		...
		cat $INSTANCECFG
                ...
                exp_message3_1="To check the status of the subsystem:"
                rlAssertGrep "$exp_message3_1" "$INSTANCE_CREATE_OUT"
                exp_message3_2="systemctl status pki-quarkusd@$(eval echo \$CLONE_TKS${number}_TOMCAT_INSTANCE_NAME).service"
                rlAssertGrep "$exp_message3_2" "$INSTANCE_CREATE_OUT"
                exp_message4_1="To restart the subsystem:"
                rlAssertGrep "$exp_message4_1" "$INSTANCE_CREATE_OUT"
                exp_message4_2=" systemctl restart pki-quarkusd@$(eval echo \$CLONE_TKS${number}_TOMCAT_INSTANCE_NAME).service"
                rlAssertGrep "$exp_message4_2" "$INSTANCE_CREATE_OUT"
                exp_message5="The URL for the subsystem is:"
                rlAssertGrep "$exp_message5" "$INSTANCE_CREATE_OUT"
...
rhcs_install_cloneTPS(){
	...
	local TKS=$5
		...
		echo "pki_ca_uri=https://$(hostname):$(eval echo \$CLONE_CA${number}_SECURE_PORT)" >> $INSTANCECFG
                ...
                exp_message3_1="To check the status of the subsystem:"
                rlAssertGrep "$exp_message3_1" "$INSTANCE_CREATE_OUT"
                exp_message3_2="systemctl status pki-quarkusd@$(eval echo \$CLONE_TPS${number}_TOMCAT_INSTANCE_NAME).service"
                rlAssertGrep "$exp_message3_2" "$INSTANCE_CREATE_OUT"
                exp_message4_1="To restart the subsystem:"
                rlAssertGrep "$exp_message4_1" "$INSTANCE_CREATE_OUT"
                exp_message4_2=" systemctl restart pki-quarkusd@$(eval echo \$CLONE_TPS${number}_TOMCAT_INSTANCE_NAME).service"
                rlAssertGrep "$exp_message4_2" "$INSTANCE_CREATE_OUT"
                exp_message5="The URL for the subsystem is:"
                rlAssertGrep "$exp_message5" "$INSTANCE_CREATE_OUT"
