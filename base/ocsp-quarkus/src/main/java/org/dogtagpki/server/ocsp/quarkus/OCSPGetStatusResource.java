...
/**
 * JAX-RS resource replacing the legacy GetStatus CMSServlet for OCSP.
 *
 * Legacy URL: /admin/ocsp/getStatus
 */
@Path("admin/ocsp/getStatus")
public class OCSPGetStatusResource {

    private static final Logger logger = LoggerFactory.getLogger(OCSPGetStatusResource.class);
    ...
    public Response getStatus() {
        logger.debug("OCSPGetStatusResource.getStatus()");
        try {
            ...
            logger.warn("OCSPGetStatusResource: Failed to get status", e);
