...
/**
 * JAX-RS resource replacing the legacy ListCerts CMSServlet.
 * Lists certificates matching a filter with pagination.
 * Legacy URL: /ee/ca/listCerts
 */
@Path("ee/ca/listCerts")
public class CAListCertsResource {

    private static final Logger logger = LoggerFactory.getLogger(CAListCertsResource.class);
    ...
    public Response listCerts(
        ...
        logger.info("CAListCertsResource: Listing certificates");
        ...
        try {
            ...
            logger.error("CAListCertsResource: Error: {}", e.getMessage(), e);
            result.put("Status", "1");
