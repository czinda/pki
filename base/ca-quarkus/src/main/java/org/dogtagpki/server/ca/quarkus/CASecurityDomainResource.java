...
public class CASecurityDomainResource {
    ...
    public Response getInstallToken(
        ...
        logger.debug("CASecurityDomainResource.getInstallToken(): hostname={}, subsystem={}", hostname, subsystem);
    ...
    public Response getHosts() throws Exception {
        logger.debug("CASecurityDomainResource.getHosts()");
    ...
    public Response getHost(@PathParam("hostId") String hostId) throws Exception {
        logger.debug("CASecurityDomainResource.getHost(): hostId={}", hostId);
    ...
    public Response addHost(String requestData) throws Exception {
        logger.debug("CASecurityDomainResource.addHost()");
    ...
    public Response removeHost(@PathParam("hostId") String hostId) throws Exception {
        logger.debug("CASecurityDomainResource.removeHost(): hostId={}", hostId);
