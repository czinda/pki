...
/**
 * JAX-RS resource replacing the legacy GetStatus CMSServlet for KRA.
 *
 * Legacy URL: /admin/kra/getStatus
 */
@Path("admin/kra/getStatus")
public class KRAGetStatusResource {

    private static final Logger logger = LoggerFactory.getLogger(KRAGetStatusResource.class);
    ...
    public Response getStatus() {
        logger.debug("KRAGetStatusResource.getStatus()");
        try {
            ...
            logger.warn("KRAGetStatusResource: Failed to get status", e);
