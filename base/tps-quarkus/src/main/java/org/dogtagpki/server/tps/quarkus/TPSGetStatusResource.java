...
/**
 * JAX-RS resource replacing the legacy GetStatus CMSServlet for TPS.
 *
 * Legacy URL: /admin/tps/getStatus
 */
@Path("admin/tps/getStatus")
public class TPSGetStatusResource {

    private static final Logger logger = LoggerFactory.getLogger(TPSGetStatusResource.class);
    ...
    public Response getStatus() {
        logger.debug("TPSGetStatusResource.getStatus()");
        try {
            ...
            logger.warn("TPSGetStatusResource: Failed to get status", e);
