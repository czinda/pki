...
# Build Quarkus modules by default unless --without quarkus is specified.
%bcond_without quarkus
...
Runs as a standalone Quarkus process.
...
# Create systemd target wants directories for Quarkus
install -dm 755 %{buildroot}%{_sysconfdir}/systemd/system/pki-quarkusd.target.wants
