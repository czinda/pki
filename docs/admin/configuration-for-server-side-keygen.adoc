...
[literal]
Systemctl stop pki-quarkusd@<ca_instance_name>.service
e.g.
# Systemctl stop pki-quarkusd@pki-ca.service
...
[literal]
systemctl start pki-quarkusd@<ca_instance_name>.service
e.g.
# Systemctl start pki-quarkusd@pki-ca.service
