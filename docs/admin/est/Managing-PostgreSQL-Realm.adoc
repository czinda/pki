...
Certificate:
    Data:
        ...
        Issuer: O=EXAMPLE, OU=pki-quarkus, CN=CA Signing Certificate
        Validity
...
----
$ psql -U est -t -A -c "INSERT INTO user_certs VALUES ('est-test-user', '2;67939231264256858734977554404570695488;CN=CA Signing Certificate,OU=pki-quarkus,O=EXAMPLE;CN=test.example.com', pg_read_binary_file('/cert.der'));" est
----
