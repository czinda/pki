...
[literal]
....
# cat >/var/lib/pki/pki-quarkus/conf/est/backend.conf <<EOF
...
[literal]
....
# cat >/var/lib/pki/pki-quarkus/conf/est/authorizer.conf <<EOF
...
[literal]
....
# cat >/var/lib/pki/pki-quarkus/conf/est/realm.conf <<EOF
