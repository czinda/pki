...
This will create a server in /var/lib/pki/pki-quarkus with configuration files in /var/lib/pki/pki-quarkus/conf.
...
....
$ modutil \
    -dbdir /var/lib/pki/pki-quarkus/conf/alias \
    -add p11-kit-trust \
...
[literal]
....
$ pki -d ~/.dogtag/pki-quarkus/ca/alias -c <client password> nss-create
....
...
....
$ modutil \
    -dbdir ~/.dogtag/pki-quarkus/ca/alias \
    -add p11-kit-trust \
    -libfile /usr/share/pki/lib/p11-kit-trust.so
....
