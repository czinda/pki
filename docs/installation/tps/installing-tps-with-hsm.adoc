...
It installs a TPS subsystem in a Tomcat instance (default is pki-quarkus) and creates the following NSS databases:

* server NSS database: /var/lib/pki/pki-quarkus/conf/alias

* admin NSS database: ~/.dogtag/pki-quarkus/tps/alias
