...
The command will create the initial configuration files in `/var/lib/pki/pki-quarkus/conf/acme` folder.
...
The command will create a deployment descriptor at `/var/lib/pki/pki-quarkus/conf/Catalina/localhost/acme.xml`.
...
The command will remove the deployment descriptor at `/var/lib/pki/pki-quarkus/conf/Catalina/localhost/acme.xml`.
