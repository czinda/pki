...
---------------
  ...
  Subject DN: CN=CA Audit Signing Certificate,OU=pki-quarkus,O=EXAMPLE
  ...

  Serial Number: 0x65f868071ebf5e2cdc18392239a53081
  Subject DN: CN=Subsystem Certificate,OU=pki-quarkus,O=EXAMPLE
  ...
  ...
  Subject DN: CN=pki.example.com,OU=pki-quarkus,O=EXAMPLE
  ...

  Serial Number: 0xe6f644e5f52dad59bc1f118f73f26155
  Subject DN: CN=CA OCSP Signing Certificate,OU=pki-quarkus,O=EXAMPLE
  ...

  Serial Number: 0xf43eb9d05996aec15333108150491971
  Subject DN: CN=PKI Administrator,E=caadmin@example.com,OU=pki-quarkus,O=EXAMPLE
  ...
----------------------------
