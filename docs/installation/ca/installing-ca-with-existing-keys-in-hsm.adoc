...
It installs a CA subsystem in a Tomcat instance (default is pki-quarkus) and creates the following NSS databases:

* server NSS database: /var/lib/pki/pki-quarkus/conf/alias

* admin NSS database: ~/.dogtag/pki-quarkus/ca/alias
...
[literal]
....
$ certutil -L -d /var/lib/pki/pki-quarkus/conf/alias -h HSM -f HSM.pwd -n "HSM:ca_signing" -a > ca_signing.crt
$ certutil -L -d /var/lib/pki/pki-quarkus/conf/alias -h HSM -f HSM.pwd -n "HSM:ca_ocsp_signing" -a > ca_ocsp_signing.crt
$ certutil -L -d /var/lib/pki/pki-quarkus/conf/alias -h HSM -f HSM.pwd -n "HSM:ca_audit_signing" -a > ca_audit_signing.crt
....
...
[literal]
....
$ certutil -L -d /var/lib/pki/pki-quarkus/conf/alias
...
[literal]
....
$ certutil -L -d /var/lib/pki/pki-quarkus/conf/alias -h HSM -f HSM.pwd
...
$ pki -c Secret.123 pkcs12-import \
    --pkcs12 ~/.dogtag/pki-quarkus/ca_admin_cert.p12 \
