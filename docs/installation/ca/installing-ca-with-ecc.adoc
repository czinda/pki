...
Prepare a deployment configuration, for example `ca-ecc.cfg`, to deploy CA subsystem. By default the subsystem is deployed into a Tomcat instance called `pki-quarkus`.
